...
```javascript
dmeanwd = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dmeanwd@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-dmeanwd/tags). For example,

```javascript
dmeanwd = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dmeanwd@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dmeanwd = require( 'path/to/vendor/umd/stats-strided-dmeanwd/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dmeanwd@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-dmeanwd.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-dmeanwd

[test-image]: https://github.com/stdlib-js/stats-strided-dmeanwd/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-strided-dmeanwd/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-dmeanwd/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-dmeanwd?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-dmeanwd.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-dmeanwd/main
...
[deno-url]: https://github.com/stdlib-js/stats-strided-dmeanwd/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-strided-dmeanwd/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-strided-dmeanwd/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-strided-dmeanwd/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-strided-dmeanwd/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-strided-dmeanwd/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-strided-dmeanwd/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-dmeanwd/main/LICENSE
